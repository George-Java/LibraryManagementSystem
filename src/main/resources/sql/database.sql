...
(
    id           INT AUTO_INCREMENT PRIMARY KEY COMMENT '操作员编号',
...
VALUES (101, 'Johnny', '男', 24, '1000000', '452167200104064537', '2025-06-04', 1, 'root', '123456'),
       (102, 'Tom', '女', 28, '1000001', '452167199501154538', '2020-03-12', 0, 'user1', '123456'),
       (103, 'Steve', '男', 30, '1000002', '452167199301215539', '2019-11-05', 0, 'user2', '123456');
ALTER TABLE tb_operator AUTO_INCREMENT = 104;
...
(
    ...
    date           DATE         NOT NULL COMMENT '会员有效日期',
...
INSERT INTO tb_reader (barcode, name, sex, age, profession, type, identityCard, maxNum, date, phone, keepMoney,
                       dateOfIssuance)
VALUES ('R20230001', '李明', '男', 25, '工程师', '身份证', '110101199801013456', 5, '2025-12-31',
        '13800138001', 100.00, '2023-01-15'),
       ('R20230002', '王芳', '女', 22, '研究生', '身份证', '210103200101023457', 5, '2024-12-31',
        '13900139002', 100.00, '2023-02-20'),
       ('R20230003', '张伟', '男', 30, '教师', '身份证', '310105199302034568', 8, '2026-12-31', '13700137003',
        200.00, '2023-03-10');
...
VALUES ('9787121346244', 'T0001', '深入理解计算机系统', 'Randal E.Bryant', '机械工业出版社', NULL, '2019-02-01',
        139.00),
       ('9787115474582', 'T0001', 'Python编程：从入门到实践', 'Eric Matthes', '人民邮电出版社', '袁国忠', '2020-07-01',
        89.00),
       ('9787020153981', 'I00001', '百年孤独', '加西亚·马尔克斯', '南海出版公司', '范晔', '2017-09-01', 55.00),
       ('9787544291170', 'I00001', '解忧杂货店', '东野圭吾', '南海出版公司', '李盈春', '2020-03-01', 59.60),
       ('9787040396638', 'M00001', '高等数学（第七版）', '同济大学数学系', '高等教育出版社', NULL, '2014-07-01', 58.70),
...
(
    ...
    date           DATE     NOT NULL COMMENT '订购日期',
...
VALUES ('9787121346244', '2023-05-01', 5, 102, 0, 0.1),
       ('9787115474582', '2023-05-02', 10, 103, 1, 0.15),
       ('9787040396638', '2023-05-03', 15, 102, 1, 0.2),
       ('9787111550697', '2023-05-04', 8, 103, 0, 0.1);
...
VALUES ('R20230001', '9787121346244', 102, 0, '2023-06-01', NULL),
       ('R20230001', '9787115474582', 102, 1, '2023-06-01', '2023-06-15'),
       ('R20230002', '9787020153981', 103, 0, '2023-06-02', NULL),
       ('R20230003', '9787040396638', 103, 0, '2023-06-03', NULL);
